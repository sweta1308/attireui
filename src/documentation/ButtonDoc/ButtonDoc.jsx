...
export const ButtonDoc = () => {
  ...
  return (
    <>
      ...
      <p>
        <strong>buttonText: </strong>This represents the text which we want to
        show on the button.
      </p>
      <p>
        <strong>styles: </strong>This will contain all the styles which you want
        to apply to the button and it will take the styles in the form of an
        object.
      </p>
      <h2>Examples</h2>
      ...
      <p>
        <strong>linkSrc: </strong>This will contain the URL to which you want
